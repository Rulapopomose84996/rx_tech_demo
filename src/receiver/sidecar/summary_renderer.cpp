             ...
             {{"run", {{"status", summary.run.status}, {"error_message", summary.run.error_message}}},
              ...
              {"capture",
               {{"capture_policy", summary.capture.capture_policy},
                ...
                {"raw_record_role", summary.capture.raw_record_role},
                {"raw_record_output_dir", summary.capture.raw_record_output_dir},
                {"raw_record_latest_file_path", summary.capture.raw_record_latest_file_path}}},
              {"performance",
